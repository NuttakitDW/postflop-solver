...
# Oracle Lookup Table
cargo run --example build_oracle --release --features "bincode rayon" -- config/A-oracle.json 
cargo run --example solve_flop --release --features "bincode rayon" -- config/A-oracle.json 